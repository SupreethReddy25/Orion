...
# --- Add our 'src' folder to the Python path ---
# This lets us import from our 'src' folder
...
try:
    ...
    print("Successfully imported OrionDataset from src/data_utils.py")
except ImportError:
    print("ERROR: Could not import OrionDataset. Make sure src/data_utils.py exists.")
    sys.exit(1)
# --- 1. Configuration ---
